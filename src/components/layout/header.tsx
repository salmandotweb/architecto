	...
	return (
		<div className="flex items-center justify-between w-full px-6 py-5">
			<div className="flex items-center gap-2">
				<a href="https://github.com/salmandotweb/architecto">
					<img
						alt="GitHub Repo stars"
						src="https://img.shields.io/github/stars/salmandotweb/architecto?logoColor=ssd&style=social"
					/>
				</a>
				<a href="https://github.com/salmandotweb/architecto">
					<img
						alt="GitHub forks"
						src="https://img.shields.io/github/forks/salmandotweb/architecto?style=social"
					/>
				</a>
				<a
